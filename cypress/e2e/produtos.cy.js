...
import contrato from '../contratos/produto.contrato'
...
describe('Teste de API em produtos', () => {
    ...
    it('Deve validar contrato de produto com sucesso', () => {
    ...
    it('Deve cadastrar produto com sucesso - POST', () => {
        ...
        cy.cadastarProduto(token, produto, 10, 'Cabo USB C', 100)
        .should((response) => {
    ...
    it('Deve validar mensagem de produto cadastrado anteriormente - POST', () => {
        cy.cadastarProduto(token, 'Logitech MX Vertical', 10, 'Cabo USB C', 100)
        .should((response) => {
    ...
    it('Deve editar um produto com sucesso - PUT', () => {
        ...
        cy.cadastarProduto(token, produto, 10, 'Produto EBAC Editado', 100)
        .then(response => {
    ...
    it('Deve deletar um produto com sucesso - DELETE', () => {
        cy.cadastarProduto(token, 'Produto EBAC a ser deletado', 100, 'delete', 50)
        .then(response => {
           let id = response.body._id
           cy.request({
            method: 'DELETE',
